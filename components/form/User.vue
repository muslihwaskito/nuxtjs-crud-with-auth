<template>
  <div>
    ...
    <div class="form-group">
      ...
      <p v-if="$route.name == 'users-edit-id'">
    ...
    <div v-if="$route.name == 'users-add'" class="form-group">
      <label for="">Photo</label>
      <input type="file" class="form-control" @change="onImageChange">
    </div>
    <div v-if="$route.name == 'users-edit-id'" class="form-group">
      <label for="">Change Photo</label>
      <input type="file" class="form-control" @change="onImageChange">
    </div>
    <div v-if="$route.name == 'users-edit-id' && users.url" class="form-group">
      <label for="">Photo</label>
  ...
  methods: {
    ...
    submit(){
      ...
      if (this.$route.name == 'users-edit-id') {        
        ...
        this.storeUserData(form).then(() => this.$router.push({name: 'users'}))
      }
    },
    onImageChange(e){
